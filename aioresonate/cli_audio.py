...
class AudioPlayer:
    ...
    def _check_and_prepare_chunk(
        ...
        # If chunk is in the future, wait for it without drift correction
        # (drift correction would cause hard syncs while we're just waiting)
        ...
        # Only apply drift correction when actively consuming chunks
