...
This is the simplified, hook-based PlayerRole that replaces the legacy
implementation with legacy methods like send_audio, send_stream_start, etc.
"""
...
class PlayerRole(Role):
    ...
    This simplified implementation uses hook methods for the streaming lifecycle:
