...
class SendspinGroup:
    ...
    def start_stream(
        ...
        *,
        ...
        update_playback_state: bool = True,
    ) -> PushStream:
        """
        ...
        Args:
            ...
            update_playback_state: Whether to mark this group as PLAYING and
                broadcast a group/update message. Set to False for transport-only
                stream changes where logical playback state should be preserved.
    ...
    def stop_stream(self) -> None:
        ...
        Transport lifecycle only: this does not change group playback state.
    ...
    async def stop(self) -> bool:
        ...
        This is a semantic playback stop: it stops active transport and updates
        group state to STOPPED.
